...
createElement(tag = "input",properties = [ ["type", "text"], ["placeholder", "dolor sit amet"], ],styles = [ ["fontSize", "18px"], ["color", "red"], ],parentElem = document.querySelector(".main-block"));
// Создаем таблицу 
createElement(tag = "table",properties = [],styles = [["width", "180px"], ["height", "180px"]],parentElem = document.querySelector(".main-block"),4,5,[["border","5px solid black"]]);
